...
<head>
	...
	<body class="defult-home">
		...
		<div class="main-content">
			...
			<div class="rs-services services-main-home services-modify1 pt-120 pb-120 md-pt-80 md-pb-80 bg-color-2">
				<div class="container">
					<div class="row">
						<div class="col-lg-6">
					...
					<div class="row">
						<div class="col-lg-3 col-md-6 md-mb-30">
							<div class="services-item bg-color-1">
							...
							<div class="services-item bg-color-1">
								<div class="services-wrap">
									...
									<div class="services-content">
										...
										<p class="services-txt">The dedication and enthusiasm of the team has helped us achieve so much within a short span of time and have a strong clientele to our credit.</p>
									</div>
								</div>
							</div>
						</div>
			...
			<!-- Services Section Start -->
			<div class="rs-services services-style1 pt-120 pb-120 md-pt-80 md-pb-80 bg-color-3">
			    <div class="container">
			    	<div class="sec-title text-center mb-40 md-mb-25">
			    		<span class="sub-text title-white">Our Services</span>
			    		<h2 class="title">
			    			...
			    			<div class="services-item bg-color-1">
			    				<div class="services-wrap">
			    					...
			    					<div class="services-content">
										...
										<p>Developing position specific competency packages involving the entire spectrum starting from job title, principal accountabilities, key result areas, external/internal contacts, reporting and supervising relationships, working environment, job specifications, approximate compensation and other relevant details.</p>
			    					</div>
			    				</div>
			    			</div>
			    		</div>
			...
			<!-- Faq Start -->
			<div class="rs-faq faq-style1 pt-120 pb-120 md-pt-80 md-pb-80 bg-color-2">
				<div class="container">
					<div class="row">
						<div class="col-lg-6 pr-55 md-pr-15 md-mb-50">
							<div class="sec-title mb-45">
								<span class="sub-text title-white">Faq</span>
								<h2 class="title title-yellow">
									Asked Any Questions
								</h2>
							</div>
			    	...
			    	<div class="sec-title mb-45">
			       	...
			       	<div class="rs-carousel owl-carousel" data-loop="true" data-items="2" data-margin="30" data-autoplay="true" data-hoverpause="true" data-autoplay-timeout="5000" data-smart-speed="800" data-dots="false" data-nav="false" data-nav-speed="false" data-center-mode="false" data-mobile-device="1" data-mobile-device-nav="false" data-mobile-device-dots="false" data-ipad-device="2" data-ipad-device-nav="false" data-ipad-device-dots="true" data-ipad-device2="2" data-ipad-device-nav2="false" data-ipad-device-dots2="true" data-md-device="2" data-md-device-nav="false" data-md-device-dots="true">
		        		<div class="testi-item">
		        			<div class="testi-wrap bg-color-2">
		        				<div class="item-content-basic">
		        					<span>
		        						<img src="assets/images/testimonial/style1/quote.png" alt="Images">
		        					</span>
		        					<p class="title-white">Education is the passport to the future for the tomor row belongs to those who pre pare for it today. Sed ut perspiciatis unde omnis natus errorsit vo luptatem. Education is the passport to the future credit repair.</p>
		        				</div>
		        				<div class="testi-content">
				                    ...
				                    <div class="testi-information">
	                                    <div class="testi-name title-yellow">Nikoling Toli</div>
